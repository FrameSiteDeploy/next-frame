            ...
            {services.map((item) => (
                ...
                >
                    <Image
                        ...
                        src={item.image}
                        alt={item.title}
                        className="absolute right-0 top-0 2xl:translate-x-[calc(100%+40px)] xl:translate-x-[calc(100%+20px)] 2xl:w-40 2xl:h-[93px] xl:w-35 xl:h-20 hidden group-data-[state=open]:block"
                    />
